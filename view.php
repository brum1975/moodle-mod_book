...
if ($previd) {
    if ($book->linkstyle == 0){
        ...
        $chnavigation .= '<a title="'.get_string('navprev', 'book').'" href="view.php?id='.$cm->id.
            '&amp;chapterid='.$previd.'"><span class="chaptername"><span class="arrow">'.$OUTPUT->larrow().'&nbsp;</span>'.get_string('navprev', 'book').':&nbsp;'.$prevtitle.'</span></a>';
    }
...
if ($nextid) {
    if ($book->linkstyle == 0){
        ...
        $chnavigation .= '<a title="'.get_string('navnext', 'book').'" href="view.php?id='.$cm->id.
            '&amp;chapterid='.$nextid.'">'.get_string('navnext', 'book').':<span class="chaptername">&nbsp;'.$nexttitle.'<span class="arrow">&nbsp;'.$OUTPUT->rarrow().'</span></span></a>';
    }
    ...
    if ($book->linkstyle == 0){
        ...
        $chnavigation .= '<a title="'.get_string('navexit', 'book').'" href="'.$returnurl.'"><span class="chaptername">'.get_string('navexit', 'book').'<span class="chaptername"></a>';
    }
